using BankingAppAuthenticationTier.Contracts.Contants;
using BankingAppAuthenticationTier.Contracts.Database;
using BankingAppAuthenticationTier.Contracts.Dtos.Entities;
using BankingAppAuthenticationTier.Contracts.Dtos.Inputs;
using BankingAppAuthenticationTier.Contracts.Dtos.Outputs;
using BankingAppAuthenticationTier.Contracts.Dtos.Outputs;
...
namespace BankingAppAuthenticationTier.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class AuthenticationController : Controller
    {
        ...
        public ActionResult<AuthenticateOutput> Authenticate([FromBody] AuthenticateInput input)
        {
            ...
            if (clientInDb == null)
            {
                ...
                {
                    Token = string.Empty,
                    Error = ClientErrors.InvalidClient,
                });
            }
